...
export default function Product() {
  ...
  const coverSrc = product.cover
    ...
    : product.cover_image || 'https://placehold.co/500x500/ccc/333?text=No+Image'
      ...
      >
        ...
        <Box sx={{ flex: 1, mt: { xs: 3, md: 0 } }}>
          ...
          <Box sx={{ mt: 3, mb: 3 }}>
            {product.price_final ? (
              ...
              >
                ...
                >
                  $
                  {Number(product.price_final).toLocaleString('es-MX')}
                </Typography>

                {product.price_original && product.price_original !== product.price_final && (
                  <Typography
                    variant="body1"
                    sx={{
                  ...
                  >
                    $
                    {Number(product.price_original).toLocaleString('es-MX')}
                  </Typography>
                )}
              </Box>
            ) : (
              ...
              >
                $
                {Number(product.price_final || 0).toLocaleString('es-MX')}
              </Typography>
            )}
          </Box>
          ...
          <Typography
            variant="body2"
            sx={{
              color: product.stock > 0 ? '#059669' : '#dc454d',
              mb: 3,
              fontWeight: 500,
            }}
          >
          ...
          >
            ...
            >
              ...
              <Typography
                ...
                sx={{ color: '#6b7280' }}
              >
                / 5 · {product.review_count} reseñas
              </Typography>
            </Box>
          </Box>
