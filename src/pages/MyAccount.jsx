...
export default function MyAccount() {
  ...
  const handleAvatarUpload = async (file) => {
    ...
    try {
      ...
      console.error(err)
      alert(err.message || 'No se pudo actualizar la foto de perfil')
    } finally {
              ...
              >
                <Avatar
                  src={
                    avatarPreview ||
                    (userData.avatar_url
                      ? `${import.meta.env.VITE_API_URL}${userData.avatar_url}`
                      : undefined)
                  }
          ...
          {editingProfile ? (
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: 1.5 }}>
              ...
              <Box>
                ...
                <Typography variant="body2" fontWeight={500}>{userData.phone_number || '—'}</Typography>
              </Box>
              <Box>
